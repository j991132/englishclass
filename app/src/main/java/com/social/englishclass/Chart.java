...
public class Chart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart_title.setText(login_id + " 의 누적 평가 결과");
...
// x값 y값 좌표 배열에 입력
                    ...
                    entry_chart_accent.add(new Entry(j, accent_y + 0.02f));
//                    String file = searchname.substring(searchname.lastIndexOf("_")+1);
//                    entry_chart_accent.add(new Entry(Integer.parseInt(file.substring(2,4)+file.substring(6,8)+file.substring(10,12)), accent_y));
                    Log.e("엔트리 차트 악센트 배열", "" + entry_chart_accent);
                    ...
                    entry_chart_speed.add(new Entry(j, speed_y - 0.02f));
...
//y축 설정
                ...
                yAxis_R.setGranularity(1);
                yAxis_R.setAxisMinimum(0);
                yAxis_R.setAxisMaximum(4);
                yAxis_R.setTextSize(20);
                yAxis_R.setValueFormatter(new IndexAxisValueFormatter(y_name));
...
//                Collections.sort(mUploads, sortByTotalCall);
    ...
    public void accent_chart() {
        ...
        lineDataSet_accent.setValueTextSize(0);
    ...
    public void pronunciation_chart() {
        ...
        lineDataSet_pronunciation.setValueTextSize(0);
    ...
    public void speed_chart() {
        ...
        lineDataSet_speed.setValueTextSize(0);
...
//라인차트 설정(stress)
        ...
        lineDataSet_stress.setValueTextSize(0);
