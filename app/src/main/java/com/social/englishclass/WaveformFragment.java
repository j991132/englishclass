...
import com.social.englishclass.soundfile.CheapSoundFile;
import com.social.englishclass.view.MarkerView;
import com.social.englishclass.view.WaveformView;
...
//        mTilte = recordserverplay.filename;
    ...
    protected void loadGui(View view) {
        ...
        markStartButton.setVisibility(View.GONE);
        markStartButton.setOnClickListener(mMarkStartListener);
        TextView markEndButton = (TextView) view.findViewById(R.id.mark_end);
        markEndButton.setVisibility(View.GONE);
